...
def plotPlaneLine(xg,yg,zg,Whitpoint,area,a1,a2):
    ...
    if(Whitpoint == 0):
        plt.text(10,70,'Esta fuera del plano')
    else:
        plt.text(10,70,'Esta dentro del plano')
    
    plt.text(10,90,'A=' + str(area))
    plt.text(10,85,'A1=' + str(a1))
    plt.text(10,80,'A2=' + str(a2))
    plt.text(10,75,'A2 + A1=' + str(a2 + a1))
...
def hitpoint(x,y,z):
    ...
    Whitpoint=0
    if ((a1+a2)>area):
        Whitpoint = 0  #esta fuera de los limites
    else:
        Whitpoint = 1 #esta dentro
    
    
    #return xh,yh,xhg,yhg,hitcolor
    plotPlaneLine(xg,yg,zg,Whitpoint,area,a1,a2) 
...
#
print("Teclea el eje que deseas visualizar 'x,y,z' o esc?:")
while True:
    try:
        ...
        if keyboard.is_pressed('z'):
            ...
            plotPlaneLinex(xc,yc,zc,Rz,hx1,hx2,hy1,hy2)#LLamamos a la funcion de ploteo 
            print("Teclea el eje que deseas visualizar 'x,y,z' o esc?:")
